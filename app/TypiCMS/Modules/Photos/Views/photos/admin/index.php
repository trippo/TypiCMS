<div ng-app="typicms" ng-cloak ng-controller="ListController">
    ...
    <h1>
        <a id="uploaderAddButtonContainer" href="#"><i id="uploaderAddButton" class="fa fa-plus-circle"></i><span class="sr-only">{{ ucfirst(trans('photos::global.New')) }}</span></a>
        <span translate translate-n="models.length" translate-plural="{{ models.length }} photos">{{ models.length }} photo</span>
    </h1>

    <div class="dropzone" drop-zone="" id="dropzone">
        <div class="dz-message" translate>Click or drop photos to upload.</div>
    </div>
